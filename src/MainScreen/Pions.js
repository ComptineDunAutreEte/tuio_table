...
class Pions{
    constructor(place, idp, x,y,couleur){
        ...
        if (couleur === "rouge"){this.src = 'assets/MainScreen/pionR.png'; this.widget = new PionsBRWidget(place, idp, x, y, 100,100, this.src);}
        else if (couleur === "bleu") {this.src = 'assets/MainScreen/pionB.png'; this.widget = new PionsBRWidget(place, idp, x, y, 100,100, this.src);}
        else if (couleur === "bleuS") {this.src = 'assets/MainScreen/pionBS.png';}
        else if (couleur === "rougeS") {this.src = 'assets/MainScreen/pionRS.png';}
        else if (couleur === "none") {this.src = 'assets/MainScreen/pionN.png'; this.widget = new PionsWidget(idp, x, y, 100,100, this.src);}
        else {this.src = 'assets/MainScreen/pionNBR.png';this.widget = new PionsBRWidget(idp, x, y, 100,100, this.src);}
